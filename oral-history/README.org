...
This is a very small website organized around an audio element. Though it's intended to be used as apart of a larger project, it can also stand on its own.  It looks pretty good, but most of the heavy lifting is done by outside libraries:
...
- I also include local copies of [[popcorn-complete.js][the popcorn]] and [[tabletop.js][tabletop libraries]].  
